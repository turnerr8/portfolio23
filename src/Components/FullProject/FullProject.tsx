    ...
    return(
        <motion.div
            ...
            <motion.div
                ...
                variants={modal}
                className=" w-full md:w-11/12 bg-white rounded-3xl relative flex flex-col overflow-hidden text-left"
                ...
                <div className=" container p-6 m-3 flex flex-col justify-around w-full">
                    <h1 className=" text-3xl md:text-5xl font-bold mb-4">{props.title}</h1>
                    <h5 className=" text-sm md:text-lg font-bold mb-3 md:mb-6 text-subheading-black">{props.date}</h5>
                    <p className=" md:text-xl my-8">{props.description}</p>
