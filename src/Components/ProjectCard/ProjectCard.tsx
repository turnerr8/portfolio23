		...
		>
			<div className='flex flex-row '>
				<div className='flex flex-col w-11/12 text-left p-7'>
					<h1 className=' text-white font-bold text-3xl lg:text-5xl mb-5'>
						{props.title}
					</h1>
					<h3 className=' text-subheading-white font-bold text-xl lg:text-3xl'>
						{props.tagline}
					</h3>
				</div>
			...
			<AnimatePresence initial={false} mode='wait' onExitComplete={() => null}>
				{expanded && <FullProject {...props} closeFunction={handleClose} />}
			</AnimatePresence>
